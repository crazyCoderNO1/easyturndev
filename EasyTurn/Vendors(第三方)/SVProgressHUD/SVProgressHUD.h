...
+ (SVProgressHUD*_Nullable)sharedView;
...
@property (assign, nonatomic) CGSize constraintSize;                                        // default is 200 * 300 , stautslabel MaxSize
...
+ (void)setConstraintSize:(CGSize)constraintSize;                   // default is CGSize(200, 300), stautslabel maxSzie
...
+ (void)setViewForHUDView:(nonnull UIView*)view;                  // default is nil
...
+ (void)showViewHUD:(nonnull UIView *)view status:(NSString*_Nullable)status;
