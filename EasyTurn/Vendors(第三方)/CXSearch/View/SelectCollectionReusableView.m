...
-(void)layoutSubviews{
    ...
    self.imageView.frame = CGRectMake(0.0f, (self.frame.size.height - 18.0f) / 2, 18, 18);
    self.textLabel.frame = CGRectMake(18 +5.0f, (self.frame.size.height - 18.0f) / 2, 100.0f, 18);
    self.delectButton.frame = CGRectMake(self.frame.size.width - 65 , (self.frame.size.height - 30.0f)/2, 65, 30);
}
- (void)delect
{
