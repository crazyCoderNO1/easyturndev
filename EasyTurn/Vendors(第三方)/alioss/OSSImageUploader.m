...
static NSString *const AccessKey = @"1drtSVFUeMLYIE5H";
static NSString *const SecretKey = @"uufft2J6mrrWY9uiRdab8x3kHRIcB5";
static NSString *const BucketName = @"xinghou-online";
    ...
    for (UIImage *image in images) {
        if (image) {
            NSBlockOperation *operation = [NSBlockOperation blockOperationWithBlock:^{
                ...
                NSString *tempPath = [ud objectForKey:@"tmpPath"];
                NSString *imageName = [tempPath stringByAppendingPathComponent:[[NSUUID UUID].UUIDString stringByAppendingString:@".jpg"]];
