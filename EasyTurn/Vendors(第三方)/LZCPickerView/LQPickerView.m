...
//  Copyright © 2018年 李志超. All rights reserved.
//
...
#define LQPickerView_buttonHeight 40.0
...
- (void)layoutSubviews {
    ...
    self.secondLine.frame = CGRectMake(0, 40, CGRectGetWidth(self.frame), 0.5);
...
- (UILabel *)secondLine{
    if (!_secondLine) {
        ...
        _secondLine.backgroundColor = [UIColor grayColor];
