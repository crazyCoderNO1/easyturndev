...
@interface LZCSinglePickerView ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation LZCSinglePickerView
...
- (void)dealloc {
    //    JSDLog(@"ZJSinglePickerView ===== dealloc");
}
