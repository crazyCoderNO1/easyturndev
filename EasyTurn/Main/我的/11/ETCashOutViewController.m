...
#import "ETCashOutViewController.h"
#import "Masonry.h"
@interface ETCashOutViewController ()
...
@implementation ETCashOutViewController
...
- (void)centerPriceController
{
    ...
    _moneyImg.image=[UIImage imageNamed:@"登录_微信"];
